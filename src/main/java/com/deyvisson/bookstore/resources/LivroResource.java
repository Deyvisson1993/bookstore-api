package com.deyvisson.bookstore.resources;
...
import com.deyvisson.bookstore.dtos.LivroDTO;
import com.deyvisson.bookstore.service.LivroService;
...
public class LivroResource {
	...
	@GetMapping // exemplo - localhost:8080/livros?categoria=1
	public ResponseEntity<List<LivroDTO>> findAll(
			@RequestParam(value = "categoria", defaultValue = "0") Integer id_cat) {

		List<Livro> list = service.fidAll(id_cat);
